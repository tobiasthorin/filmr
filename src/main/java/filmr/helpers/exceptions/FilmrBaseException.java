...
/**
 * Encapsulates the extra exception fields that are common to all Filmr exceptions. 
 * Made to resemble standard error message, but with additional fields 
 * for a specific Filrm error code and a HttpStatus.
