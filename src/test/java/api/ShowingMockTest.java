...
public class ShowingMockTest {
    ...
    public ShowingMockTest(Long id) {
        this.id = id;
    }
    ...
    public void setup() {
        ...
        when(movie.getId()).thenReturn(new Long(1));

        theater = Mockito.mock(Theater.class);
        when(theater.getId()).thenReturn(new Long(1));
...
//        when(mockShowing.getMovie()).thenReturn(movie);
//        when(mockShowing.getTheater()).thenReturn(theater);
//        when(mockShowing.getBookings()).thenReturn(bookings);
